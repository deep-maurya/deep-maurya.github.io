            ...
            {DATA.education.map((education, index) => (
              ...
              >
                ...
                >
                  <div className="flex items-start gap-x-3 flex-1 min-w-0">
                    {education.logoUrl ? (
                      <img
                        ...
                        className="size-10 md:size-12 p-1.5 bg-white border rounded-lg ring-1 ring-border/50 overflow-hidden object-contain flex-none"
                      />
                    ) : (
                      <div className="size-10 md:size-12 border rounded-lg ring-1 ring-border/50 bg-muted flex-none" />
                    )}
                  ...
                  <div className="flex items-center gap-1 pt-0.5 text-xs tabular-nums text-muted-foreground text-right flex-none">
                    <span>
        ...
        <div className="flex min-h-0 flex-col gap-y-6">
          ...
          <div className="flex flex-col gap-y-4">
            {DATA.skills.map((group, groupId) => (
              ...
              >
                <div className="grid gap-y-2 sm:grid-cols-[8rem_1fr] sm:items-start sm:gap-x-6">
                  <h3 className="text-sm font-medium text-muted-foreground sm:pt-1.5">
                    {group.category}
                  </h3>
